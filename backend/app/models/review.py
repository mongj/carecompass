...
class Review(Base):
    ...
    google_author_name: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    ...
    published_time: Mapped[datetime] = mapped_column(DateTime, server_default=func.now())
